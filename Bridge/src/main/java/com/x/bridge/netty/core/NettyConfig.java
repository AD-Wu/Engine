...
public class NettyConfig {
    ...
    public static NettyConfig getServerConfig(int port) {
        try {
            return new NettyConfig(InetAddress.getLocalHost().getHostAddress(), port);
    ...
    public static NettyConfig getClientConfig(String host, int port) {
        try {
            return new NettyConfig(InetAddress.getByName(host).getHostAddress(), port);
        } catch (UnknownHostException e) {
            log.error(Strings.getExceptionTrace(e));
        }
        return null;
    ...
    private NettyConfig(String host, int port) {
        this.host = host;
