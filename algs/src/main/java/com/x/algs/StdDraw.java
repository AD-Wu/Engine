...
/**
 * The {@code StdDraw} class provides a basic capability for creating drawings with your programs. It uses a simple graphics model
 * that allows you to create drawings consisting of points, lines, squares, circles, and other geometric shapes in a window on
 * your computer and to save the drawings to a file. Standard drawing also includes facilities for text, color, pictures, and
 * animation, along with user interaction via the keyboard and mouse.
 * <p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code StdDraw.class} in your Java classpath. If you used our autoinstaller, you should be all
 * set. Otherwise, either download
 ...
 *   }
 *  </pre>
 * If you compile and execute the program, you should see a window appear with a thick magenta line and a blue point. This program
 * illustrates the two main types of methods in standard drawing—methods that draw geometric shapes and methods that control
 * drawing parameters. The methods {@code StdDraw.line()} and {@code StdDraw.point()} draw lines and points; the methods {@code
 * StdDraw.setPenRadius()} and {@code StdDraw.setPenColor()} control the line thickness and color. p> b>Points and lines.</b> ou
 * can draw points and line segments with the following methods:
 * <ul>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * Shade of blue used in <em>Introduction to Programming in Java</em>. It is Pantone 300U. The RGB values are approximately
     * (9, 90, 166).
     */
    public static final Color BOOK_BLUE = new Color(9, 90, 166);

    /**
     * Shade of light blue used in <em>Introduction to Programming in Java</em>. The RGB values are approximately (103, 198,
     * 243).
     */
    public static final Color BOOK_LIGHT_BLUE = new Color(103, 198, 243);

    /**
     * Shade of red used in <em>Algorithms, 4th edition</em>. It is Pantone 1805U. The RGB values are approximately (150, 35,
     * 31).
     */
    ...
    /**
     * Sets the canvas (drawing area) to be 512-by-512 pixels. This also erases the current drawing and resets the coordinate
     * system, pen radius, pen color, and font back to their default values. Ordinarly, this method is called once, at the very
    ...
    /**
     * Sets the canvas (drawing area) to be <em>width</em>-by-<em>height</em> pixels. This also erases the current drawing and
     * resets the coordinate system, pen radius, pen color, and font back to their default values. Ordinarly, this method is
     * called once, at the very beginning of a program.
     *
     * @param canvasWidth  the width as a number of pixels
     * @param canvasHeight the height as a number of pixels
     * @throws IllegalArgumentException unless both {@code canvasWidth} and {@code canvasHeight} are positive
     */
    ...
    /**
     * Sets the pen size to the default size (0.002). The pen is circular, so that lines have rounded ends, and when you set the
     * pen radius and draw a point, you get a circle of the specified radius. The pen radius is not affected by coordinate
     * scaling.
     */
    ...
    /**
     * Sets the radius of the pen to the specified size. The pen is circular, so that lines have rounded ends, and when you set
     * the pen radius and draw a point, you get a circle of the specified radius. The pen radius is not affected by coordinate
     * scaling.
     *
     ...
     * <p>
     * The predefined pen colors are {@code StdDraw.BLACK}, {@code StdDraw.BLUE}, {@code StdDraw.CYAN}, {@code StdDraw.DARK_GRAY},
     * {@code StdDraw.GRAY}, {@code StdDraw.GREEN}, {@code StdDraw.LIGHT_GRAY}, {@code StdDraw.MAGENTA}, {@code StdDraw.ORANGE},
    ...
    /**
     * Draws a line segment between (<em>x</em><sub>0</sub>, <em>y</em><sub>0</sub>) and (<em>x</em><sub>1</sub>,
     * <em>y</em><sub>1</sub>).
     *
    ...
    /**
     * Draws one pixel at (<em>x</em>, <em>y</em>). This method is private because pixels depend on the display. To achieve the
     * same effect, set the pen radius to 0 and call {@code point()}.
     *
    ...
    /**
     * Draws a point centered at (<em>x</em>, <em>y</em>). The point is a filled circle whose radius is equal to the pen radius.
    ...
    public static void point(double x, double y) {
        ...
        if (scaledPenRadius <= 1) {
            ...
            offscreen
                .fill(new Ellipse2D.Double(xs - scaledPenRadius / 2, ys - scaledPenRadius / 2, scaledPenRadius, scaledPenRadius));
        }
        draw();
    }
     ...
     * @param angle2 the angle at the end of the arc. For example, if you want a 90 degree arc, then angle2 should be angle1 +
     *               90.
     * @throws IllegalArgumentException if {@code radius} is negative
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    ...
    /**
     * Draws a polygon with the vertices (<em>x</em><sub>0</sub>, <em>y</em><sub>0</sub>), (<em>x</em><sub>1</sub>,
    ...
    /**
     * Draws a filled polygon with the vertices (<em>x</em><sub>0</sub>, <em>y</em><sub>0</sub>), (<em>x</em><sub>1</sub>,
     * <em>y</em><sub>1</sub>), ..., (<em>x</em><sub><em>n</em>–1</sub>, <em>y</em><sub><em>n</em>–1</sub>).
     *
     * @param x an array of all the <em>x</em>-coordinates of the polygon
     * @param y an array of all the <em>y</em>-coordinates of the polygon
...
*/
    ...
    /**
     * Draws the specified image centered at (<em>x</em>, <em>y</em>). The supported image formats are JPEG, PNG, and GIF. As an
     * optimization, the picture is cached, so there is no performance penalty for redrawing the same image multiple times (e.g.,
     * in an animation). However, if you change the picture file after drawing it, subsequent calls will draw the original
     * picture.
     *
    ...
    /**
     * Draws the specified image centered at (<em>x</em>, <em>y</em>), rotated given number of degrees. The supported image
    ...
    /**
     * Draws the specified image centered at (<em>x</em>, <em>y</em>), rescaled to the specified bounding box. The supported image
     * formats are JPEG, PNG, and GIF.
     *
     * @param x            the center <em>x</em>-coordinate of the image
     * @param y            the center <em>y</em>-coordinate of the image
    ...
    /**
     * Draws the specified image centered at (<em>x</em>, <em>y</em>), rotated given number of degrees, and rescaled to the
     * specified bounding box. The supported image formats are JPEG, PNG, and GIF.
     *
     * @param x            the center <em>x</em>-coordinate of the image
     * @param y            the center <em>y</em>-coordinate of the image
     * @param filename     the name of the image/picture, e.g., "ball.gif"
    ...
    /**
     * Writes the given text string in the current font, centered at (<em>x</em>, <em>y</em>) and rotated by the specified number
     * of degrees.
     *
     * @param x       the center <em>x</em>-coordinate of the text
     * @param y       the center <em>y</em>-coordinate of the text
    ...
    /**
     * Enables double buffering. All subsequent calls to drawing methods such as {@code line()}, {@code circle()}, and {@code
     * square()} will be deferred until the next call to show(). Useful for animations.
     */
    ...
    /**
     * Disables double buffering. All subsequent calls to drawing methods such as {@code line()}, {@code circle()}, and {@code
     * square()} will be displayed on screen when called. This is the default.
     */
    ...
    /**
     * Saves the drawing to using the specified filename. The supported image formats are JPEG and PNG; the filename suffix must
     * be {@code .jpg} or {@code .png}.
     *
     ...
     *
     * @return {@code true} if the user has typed a key (that has not yet been processed by {@link #nextKeyTyped()}; {@code false}
     * otherwise
     */
    ...
    /**
     * Returns the next key that was typed by the user (that your program has not already processed). This method should be
     * preceded by a call to {@link #hasNextKeyTyped()} to ensure that there is a next key to process. This method returns a
     * Unicode character corresponding to the key typed (such as {@code 'a'} or {@code 'A'}). It cannot identify action keys (such
     * as F1 and arrow keys) or modifier keys (such as control).
     *
     ...
     * <p>
     * This method takes the keycode (corresponding to a physical key) as an argument. It can handle action keys (such as F1 and
     * arrow keys) and modifier keys (such as shift and control). See {@link KeyEvent} for a description of key codes.
     *
