...
package com.x.loader;

import com.x.loader.jar.AbstractJarFile;
import com.x.loader.jar.XJarFile;
import com.x.loader.jar.JarFileWrapper;
...
public class PluginResourceManager {
     ...
     */
    public static void addRootJarFile(File file, XJarFile jarFile){
        STORAGE_MAP.forEach((k,v)->{
     ...
     * @return 插件jar文件
     */
    public static XJarFile getRootJarFile(File file){
        for (Storage value : STORAGE_MAP.values()) {
            XJarFile jarFile = value.getRootJarFile(file);
            if(jarFile != null){
                return jarFile;
            }
        }
    ...
    private static class Storage implements Closeable {
        ...
        private final Map<File, XJarFile> rootJarFileMap = new ConcurrentHashMap<>();
        ...
        public void addRootJarFile(File file, XJarFile jarFile){
        ...
        public XJarFile getRootJarFile(File file){
