...
public class CentralDirectoryEndRecord {
     ...
     * {@link IRandomAccessData}, searching backwards from the end until a valid block is
     * located.
     * @param data the source data
     * @throws IOException in case of I/O errors
     */
    CentralDirectoryEndRecord(IRandomAccessData data) throws IOException {
    ...
    private byte[] createBlockFromEndOfData(IRandomAccessData data, int size) throws IOException {
     ...
     */
    long getStartOfArchive(IRandomAccessData data) {
     ...
     */
    IRandomAccessData getCentralDirectory(IRandomAccessData data) {
    ...
    private static final class Zip64End {
        ...
        private Zip64End(IRandomAccessData data, int centralDirectoryEndOffset) throws IOException {
            this(data, new Zip64Locator(data, centralDirectoryEndOffset));
        }

        private Zip64End(IRandomAccessData data, Zip64Locator locator) throws IOException {
         ...
         * @return the central directory data
         */
        private IRandomAccessData getCentralDirectory(IRandomAccessData data) {
    ...
    private static final class Zip64Locator {
        ...
        private Zip64Locator(IRandomAccessData data, int centralDirectoryEndOffset) throws IOException {
