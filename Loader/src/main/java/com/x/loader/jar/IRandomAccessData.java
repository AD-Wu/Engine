 ...
 * @version 3.0.0
 */
public interface IRandomAccessData {
    ...
    /**
     * Returns a new {@link IRandomAccessData} for a specific subsection of this data.
     * @param offset the offset of the subsection
     * @param length the length of the subsection
     * @return the subsection data
     */
    IRandomAccessData getSubsection(long offset, long length);
