 ...
 * @version 3.0.0
 */
public class XJarEntry extends JarEntry implements IFileHeader {
    ...
    XJarEntry(XJarFile jarFile, int index, CentralDirectoryFileHeader header, AsciiBytes nameAlias) {
    ...
    /**
     * Return a {@link URL} for this {@link XJarEntry}.
