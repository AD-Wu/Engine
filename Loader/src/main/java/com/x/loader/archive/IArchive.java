 ...
 * 文件档案(jar或war)
 */
public interface IArchive extends Iterable<IArchive.Entry>, AutoCloseable {
    ...
    /**
     * Returns nested {@link IArchive}s for entries that match the specified filters.
     ...
     * @since 2.3.0
     */
    Iterator<IArchive> getNestedArchives(EntryFilter searchFilter, EntryFilter includeFilter) throws IOException;
